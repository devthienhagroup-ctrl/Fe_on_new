<template>
  <div class="pricing-editor">
    ...
    <div class="editor-header">
      <h2>Quản lý Thỏa thuận & Ký kết hợp đồng</h2>
    ...
    <div class="navigation-tabs">
      ...
      >
        <i class="fas fa-align-left"></i> Nội dung & Hình ảnh
      </button>
      <button
          class="tab-button"
      ...
      >
        <i class="fas fa-palette"></i> Giao diện & Border
      </button>
    </div>
    ...
    <div class="tab-content">
          ...
          <div class="setting-section">
            ...
            <div class="form-group" v-if="!iconPreview && !content.title.iconUrl">
              ...
              <input
                  ...
                  placeholder="/imgs/icon-thoa-thuan.png"
              />
            </div>
            ...
            <div class="form-group">
              ...
              <input
                  ...
                  placeholder="Thỏa thuận & ký kết hợp đồng triển khai bán trong 30 ngày"
              />
            </div>
            ...
            <div class="form-row">
              <div class="form-group">
                ...
                <div class="input-with-unit">
                  <input type="text" id="title-height" v-model="content.title.componentHeight" placeholder="120px" />
                  <span class="unit">px</span>
                </div>
              </div>
              <div class="form-group">
        ...
        <div class="settings-grid">
          ...
          <div class="setting-section">
            ...
            <div class="form-group">
              <div class="label" style="display: flex; justify-content: space-between">
                ...
                <AdvancedEditModal
                    v-model="content.content.description"
                ></AdvancedEditModal>
              </div>
              ...
              ">
                <div class="tiptap" v-html="content.content.description"></div>
              </div>
            </div>
          </div>
          ...
          <div class="setting-section">
            ...
            <div class="file-upload">
              ...
              <div v-if="image1Preview || content.content.image1" class="upload-preview">
                <img :src="getImageUrl(content.content.image1)" alt="Preview" />
                <div class="preview-actions">
            ...
            <div class="form-group" v-if="!image1Preview && !content.content.image1">
              <label for="image1-url">URL ảnh 1</label>
              <input
                  type="text"
                  id="image1-url"
                  v-model="content.content.image1"
                  placeholder="/imgs/anh-thoa-thuan-2.png"
              />
            </div>

            <div class="form-group">
              <label for="image1-alt">Alt text cho ảnh 1</label>
              <input
                  type="text"
                  id="image1-alt"
                  v-model="content.content.image1Alt"
                  placeholder="Ảnh thỏa thuận 2"
              />
            </div>
          </div>
          ...
          <div class="setting-section">
            ...
            <div class="file-upload">
              ...
              <div v-if="image2Preview || content.content.image2" class="upload-preview">
                <img :src="getImageUrl(content.content.image2)" alt="Preview" />
                <div class="preview-actions">
            ...
            <div class="form-group" v-if="!image2Preview && !content.content.image2">
              <label for="image2-url">URL ảnh 2</label>
              <input
                  type="text"
                  id="image2-url"
                  v-model="content.content.image2"
                  placeholder="/imgs/anh-thoa-thuan-1.png"
              />
            </div>
            ...
            <div class="form-group">
              ...
              <input
                  type="text"
                  id="image2-alt"
                  v-model="content.content.image2Alt"
                  placeholder="Ảnh thỏa thuận 1"
              />
            </div>
          </div>
        </div>
      ...
      <div v-if="activeTab === 'styles'" class="styles-settings">
        <div class="settings-grid">
          ...
          <div class="setting-section">
            ...
            <div class="form-row">
              <div class="form-group">
                ...
                <div class="input-with-unit">
                  <input type="text" id="border-width" v-model="content.styles.borderWidth" placeholder="5px" />
                  <span class="unit">px</span>
                </div>
              </div>
              <div class="form-group">
                <label for="border-style">Kiểu border</label>
                <select id="border-style" v-model="content.styles.borderStyle">
          ...
          <!-- Màu sắc -->
          <div class="setting-section">
            <h3><i class="fas fa-fill-drip"></i> Màu sắc & Chữ</h3>

            <div class="color-input-group">
              <label>Màu chữ</label>
              <div class="color-input form-group">
                <input type="color" v-model="content.styles.textColor" />
                <input type="text" v-model="content.styles.textColor" placeholder="#000000" />
              </div>
            </div>
            ...
            <div class="color-input-group">
              ...
              <div class="color-input form-group">
                ...
                <input type="text" v-model="content.styles.backgroundColor" placeholder="#ffffff" />
              </div>
            </div>
            ...
            <div class="color-input-group">
              ...
              <div class="color-input form-group">
                <input type="color" v-model="content.styles.shadowColor" />
                <input type="text" v-model="content.styles.shadowColor" placeholder="rgba(0, 0, 0, 0.1)" />
              </div>
            </div>

            <div class="form-row">
              <div class="form-group">
                <label for="font-size-desktop">Font size Desktop</label>
                <div class="input-with-unit">
                  <input type="text" id="font-size-desktop" v-model="content.styles.fontSizeDesktop" placeholder="17px" />
                  <span class="unit">px</span>
                </div>
              </div>
              <div class="form-group">
                <label for="font-size-tablet">Font size Tablet</label>
                <div class="input-with-unit">
                  <input type="text" id="font-size-tablet" v-model="content.styles.fontSizeTablet" placeholder="16px" />
                  <span class="unit">px</span>
                </div>
              </div>
            </div>
            ...
            <div class="form-row">
              <div class="form-group">
                <label for="font-size-mobile">Font size Mobile</label>
                <div class="input-with-unit">
                  <input type="text" id="font-size-mobile" v-model="content.styles.fontSizeMobile" placeholder="15px" />
                  <span class="unit">px</span>
                </div>
              </div>
              <div class="form-group">
                <label for="font-size-small-mobile">Font size Small Mobile</label>
                <div class="input-with-unit">
                  <input type="text" id="font-size-small-mobile" v-model="content.styles.fontSizeSmallMobile" placeholder="14px" />
                  <span class="unit">px</span>
                </div>
              </div>
            </div>
...
const loadData = async () => {
  try {
    ...
    if (response.data && response.data.contentJson) {
      ...
      // Get section5 data from the new structure
      const sectionData = data.section5 || {}

      // Update content with loaded data
      if (sectionData.title) {
        Object.assign(content.title, sectionData.title)
      }
      if (sectionData.content) {
        Object.assign(content.content, sectionData.content)
      }
      if (sectionData.styles) {
        Object.assign(content.styles, sectionData.styles)
      }
...
const saveChanges = async () => {
  try {
    ...
    // Prepare content data in the new structure
    const contentData = {
      section5: { ...content }
    }
    ...
    const sectionData = {
      id: SECTION_ID,
      name: content.title.titleText || 'Thỏa thuận và ký kết hợp đồng',
      contentJson: JSON.stringify(contentData, null, 2),
      sortOrder: content.title.orderNumber || 5,
      files: filesToSend
    }
...
const updateContentUrls = (file) => {
  ...
  if (content.content.image1 === tempUrl) {
    content.content.image1 = realUrl
  }
  if (content.content.image2 === tempUrl) {
    content.content.image2 = realUrl
  }
}
...
const handleImage1Upload = (event) => {
  const file = event.target.files[0]
  if (file) {
    handleFileUpload(file, 'Hình ảnh 1', image1Preview, 'content.image1')
  }
  event.target.value = ''
}
...
const removeImage1 = () => {
  if (content.content.image1) {
    handleRemoveFile(content.content.image1, 'content.image1', image1Preview)
  }
}
...
const handleImage2Upload = (event) => {
  const file = event.target.files[0]
  if (file) {
    handleFileUpload(file, 'Hình ảnh 2', image2Preview, 'content.image2')
  }
  event.target.value = ''
}
...
const removeImage2 = () => {
  if (content.content.image2) {
    handleRemoveFile(content.content.image2, 'content.image2', image2Preview)
  }
}
...
const previewImage1 = () => {
  if (content.content.image1) {
    previewImageUrl.value = getImageUrl(content.content.image1)
    showPreviewModal.value = true
  } else {
    showToast('Không có ảnh 1 để xem trước', 'warning')
  }
}

const previewImage2 = () => {
  if (content.content.image2) {
    previewImageUrl.value = getImageUrl(content.content.image2)
    showPreviewModal.value = true
  } else {
...
<style scoped>
/* Giữ nguyên phần CSS từ file gốc */
.pricing-editor {
