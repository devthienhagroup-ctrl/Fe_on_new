<template>
  <div class="pricing-editor">
    ...
    <div class="editor-header">
      <h2>Quản lý Lên ý tưởng chiến lược BĐS</h2>
    ...
    <div class="tab-content">
      ...
      <div v-if="activeTab === 'layout'" class="layout-settings">
        <div class="settings-grid">
          ...
          <div class="setting-section">
            <h3><i class="fas fa-image"></i> Hình ảnh bên trái</h3>
            ...
            <div class="file-upload">
              ...
              <div v-if="leftImagePreview || content.imageLeft" class="upload-preview">
                <img :src="getImageUrl(content.imageLeft)" alt="Left Preview" />
            ...
            <div class="form-group" v-if="!leftImagePreview && !content.imageLeft">
              <label for="image-left-url">Hoặc nhập URL ảnh</label>
              <input
                  type="text"
                  id="image-left-url"
                  v-model="content.imageLeft"
                  placeholder="/imgs/anh-len-y-tuong-1.png"
              />
            </div>
          </div>
          ...
          <!-- Hình ảnh phải -->
          <div class="setting-section">
            <h3><i class="fas fa-image"></i> Hình ảnh bên phải</h3>
            ...
            <div class="file-upload">
              ...
              <div v-if="rightImagePreview || content.imageRight" class="upload-preview">
                <img :src="getImageUrl(content.imageRight)" alt="Right Preview" />
                <div class="preview-actions">
            ...
            <div class="form-group" v-if="!rightImagePreview && !content.imageRight">
              <label for="image-right-url">Hoặc nhập URL ảnh</label>
              <input
                  type="text"
                  id="image-right-url"
                  v-model="content.imageRight"
                  placeholder="/imgs/anh-len-y-tuong-2.png"
              />
            </div>
          </div>
          ...
          <!-- Alt text -->
          <div class="setting-section">
            <h3><i class="fas fa-font"></i> Mô tả hình ảnh</h3>
            <div class="form-group">
              <label for="alt-text">Alt text cho hình ảnh</label>
              <input
                  type="text"
                  id="alt-text"
                  v-model="content.altText"
                  placeholder="Lên ý tưởng chiến lược bất động sản"
              />
            </div>

            <div class="form-group">
              <label class="checkbox-label">
                <input type="checkbox" v-model="content.styles.isRight" />
      ...
      <div v-if="activeTab === 'title'" class="title-content-settings">
        <div class="settings-grid">
          ...
          <div class="setting-section">
            ...
            <div class="form-group" v-if="!iconPreview && !content.icon">
              ...
              <input
                  ...
                  placeholder="/imgs/icon-len-y-tuong.png"
              />
            </div>
            ...
            <div class="form-group">
              ...
              <input
                  ...
                  placeholder="Lên ý tưởng chiến lược trên từng bất động sản"
              />
            </div>
          </div>
          ...
          <!-- Nội dung HTML -->
          <div class="setting-section">
            <h3><i class="fas fa-code"></i> Nội dung HTML</h3>
      ...
      <div v-if="activeTab === 'styles'" class="styles-settings">
        <div class="settings-grid">
          ...
          <div class="setting-section">
            ...
            <div class="form-row">
              <div class="form-group">
                <label for="title-width">Chiều rộng tiêu đề</label>
                <input
                    type="text"
                    id="title-width"
              ...
              <div class="form-group">
                ...
                <div class="input-with-unit">
                  <input type="number" id="circle-size" v-model.number="content.styles.circleSize" min="50" max="200" />
            ...
            <div class="form-row">
              <div class="form-group">
                ...
                <div class="input-with-unit">
                  <input type="number" id="icon-width" v-model.number="content.styles.iconWidth" min="50" max="200" />
                  <span class="unit">px</span>
                </div>
              </div>
              <div class="form-group">
                ...
                <div class="input-with-unit">
                  <input type="number" id="icon-height" v-model.number="content.styles.iconHeight" min="50" max="200" />
                  <span class="unit">px</span>
                </div>
              </div>
            </div>
            ...
            <div class="form-row">
              <div class="form-group">
                <label for="title-component-height">Chiều cao component</label>
                <div class="input-with-unit">
                  <input type="text" id="title-component-height" v-model="content.styles.titleComponentHeight" placeholder="120px" />
                  <span class="unit">px</span>
                </div>
              </div>
              <div class="form-group">
                <label for="title-component-width">Chiều rộng component</label>
                <input
                    type="text"
                    id="title-component-width"
                    v-model="content.styles.titleComponentWidth"
                    placeholder="100%"
                />
              </div>
            </div>
            ...
            <div class="color-input-group">
              ...
              <div class="color-input form-group">
                ...
                <input type="text" v-model="content.styles.borderColor" placeholder="#c2cbf0" />
              </div>
            </div>
            ...
            <div class="color-input-group">
              ...
              <div class="color-input form-group">
                ...
                <input type="text" v-model="content.styles.backgroundColor" placeholder="transparent" />
              </div>
            </div>
            ...
            <div class="color-input-group">
              ...
              <div class="color-input form-group">
                ...
                <input type="text" v-model="content.styles.textColor" placeholder="#333" />
              </div>
            </div>
            ...
            <div class="form-row">
              <div class="form-group">
                ...
                <div class="input-with-unit">
                  <input type="text" id="font-size" v-model="content.styles.fontSize" placeholder="17px" />
                  <span class="unit">px</span>
                </div>
              </div>
              <div class="form-group">
          ...
          <div class="setting-section">
            ...
            <div class="form-group">
              <label for="mobile-title-height">Chiều cao tiêu đề trên mobile</label>
              <div class="input-with-unit">
                <input type="text" id="mobile-title-height" v-model="content.responsive.mobileTitleHeight" placeholder="150px" />
                <span class="unit">px</span>
              </div>
            </div>
            ...
            <div class="form-group">
              ...
              <div class="breakpoints-grid">
                <div class="breakpoint-input">
                  <label>Desktop</label>
                  <div class="input-with-unit">
                    <input type="number" v-model.number="content.responsive.breakpoints.desktop" min="768" />
                    <span class="unit">px</span>
                  </div>
                </div>
                <div class="breakpoint-input">
                  <label>Tablet</label>
                  <div class="input-with-unit">
                    <input type="number" v-model.number="content.responsive.breakpoints.tablet" min="576" />
                    <span class="unit">px</span>
                  </div>
                </div>
                <div class="breakpoint-input">
                  <label>Mobile</label>
                  <div class="input-with-unit">
                    <input type="number" v-model.number="content.responsive.breakpoints.mobile" min="320" />
                    <span class="unit">px</span>
                  </div>
                </div>
              </div>
...
const content = reactive({
  ...
  icon: "file_20251210_112025_076.png",
  imageLeft: "file_20251210_112024_175.png",
  imageRight: "file_20251210_112024_785.png",
  altText: "Lên ý tưởng chiến lược bất động sản",
  content: `<p>Đội ngũ marketing sẽ xây dựng <b>kế hoạch truyền thông chuyên biệt cho từng bất động sản</b>, bao gồm:</p>
<ul>
  <li>Sáng tạo nội dung quảng cáo hấp dẫn, đánh trúng tâm lý người mua.</li>
  <li>Thiết kế hình ảnh và video chuyên nghiệp, làm nổi bật giá trị thật của sản phẩm.</li>
  <li>Triển khai chiến dịch quảng bá đa kênh (Facebook, Google, Zalo, sàn BĐS, website)</li>
</ul>
<p>Tối đa hóa lượng khách hàng tiềm năng và đẩy nhanh giao dịch trong 30 ngày</p>`,
  styles: {
    titleWidth: "45%",
...
const loadData = async () => {
  try {
    ...
    if (response.data && response.data.contentJson) {
      let data = typeof response.data.contentJson === 'string'
          ? JSON.parse(response.data.contentJson)
          : response.data.contentJson

      // Get section6 data
      const sectionData = data.section6 || data
...
const saveChanges = async () => {
  try {
    ...
    // Prepare content data with section6 structure
    const contentData = {
      section6: { ...content }
    }
...
const updateContentUrls = (file) => {
  ...
  if (content.imageLeft === tempUrl) {
    content.imageLeft = realUrl
  }
  if (content.imageRight === tempUrl) {
    content.imageRight = realUrl
  }
}
...
const handleLeftImageUpload = (event) => {
  ...
  if (file) {
    handleFileUpload(file, 'Hình ảnh trái', leftImagePreview, 'imageLeft')
  }
  event.target.value = ''
}
...
const removeLeftImage = () => {
  if (content.imageLeft) {
    handleRemoveFile(content.imageLeft, 'imageLeft', leftImagePreview)
  }
}

const previewLeftImage = () => {
  if (content.imageLeft) {
    previewImageUrl.value = getImageUrl(content.imageLeft)
...
const handleRightImageUpload = (event) => {
  const file = event.target.files[0]
  if (file) {
    handleFileUpload(file, 'Hình ảnh phải', rightImagePreview, 'imageRight')
  }
  event.target.value = ''
}
...
const removeRightImage = () => {
  if (content.imageRight) {
    handleRemoveFile(content.imageRight, 'imageRight', rightImagePreview)
  }
}

const previewRightImage = () => {
  if (content.imageRight) {
    previewImageUrl.value = getImageUrl(content.imageRight)
    showPreviewModal.value = true
  } else {
    showToast('Không có ảnh để xem trước', 'warning')
  }
...
.breakpoint-input .input-with-unit {
  margin-bottom: 0;
}
