<template>
  <div class="pricing-editor">
    ...
    <div class="editor-header">
      <h2>Quản lý {{ content.title || 'Triển khai bán nhanh' }}</h2>
    ...
    <div class="navigation-tabs">
      ...
      >
        <i class="fas fa-align-left"></i> Nội dung chính
      </button>
      <button
          class="tab-button"
      ...
      >
        <i class="fas fa-palette"></i> Kiểu dáng & Border
      </button>
    </div>
    ...
    <div class="tab-content">
      ...
      <div v-if="activeTab === 'content'" class="content-settings">
        <div class="settings-grid">
          ...
          <div class="setting-section">
            <h3><i class="fas fa-heading"></i> Tiêu đề & Icon</h3>

            <div class="form-group">
              <label for="title-text">Tiêu đề section</label>
              <input
                  type="text"
                  id="title-text"
                  v-model="content.title"
                  placeholder="Triển khai bán nhanh bất động sản"
              />
            </div>
            ...
            <div class="form-group" v-if="!iconPreview && !content.iconUrl">
              ...
              <input
                  ...
                  placeholder="/imgs/icon-trien-khai.png"
              />
            </div>
          </div>
      ...
      <div v-if="activeTab === 'layout'" class="layout-settings">
        <div class="settings-grid">
          ...
          <div class="setting-section">
            ...
            <div class="form-group" v-if="!imagePreview && !content.image.src">
              ...
              <input
                  ...
                  placeholder="/imgs/anh-trien-khai-1.png"
              />
            </div>
            ...
            <div class="form-row">
              <div class="form-group">
                <label for="image-width">Chiều rộng ảnh</label>
                <div class="input-with-unit">
                  <input type="text" id="image-width" v-model="content.styles.image.width" placeholder="40%" />
                  <span class="unit">%</span>
                </div>
              </div>
              <div class="form-group">
                <label for="image-position-top">Vị trí Top</label>
                <div class="input-with-unit">
                  <input type="text" id="image-position-top" v-model="content.styles.image.positionTop" placeholder="-100px" />
          ...
          <!-- Container tiêu đề -->
          <div class="setting-section">
            <h3><i class="fas fa-object-group"></i> Container tiêu đề</h3>

            <div class="form-group">
              <label for="title-container-width">Chiều rộng container</label>
              <div class="input-with-unit">
                <input type="text" id="title-container-width" v-model="content.styles.titleContainer.width" placeholder="40%" />
                <span class="unit">%</span>
              </div>
            </div>
          </div>
      ...
      <div v-if="activeTab === 'styles'" class="styles-settings">
        <div class="settings-grid">
          ...
          <div class="setting-section">
            ...
            <div class="form-row">
              <div class="form-group">
                <label for="section-margin-top">Margin Top</label>
                <div class="input-with-unit">
                  <input type="text" id="section-margin-top" v-model="content.styles.section.marginTop" placeholder="60px" />
                  <span class="unit">px</span>
                </div>
              </div>
              <div class="form-group">
                <label for="section-margin-bottom">Margin Bottom</label>
                <div class="input-with-unit">
                  <input type="text" id="section-margin-bottom" v-model="content.styles.section.marginBottom" placeholder="80px" />
                  <span class="unit">px</span>
                </div>
              </div>
            </div>
            ...
            <div class="form-row">
              <div class="form-group">
                <label for="section-padding">Padding</label>
                <input
                    type="text"
                    id="section-padding"
              ...
              <div class="form-group">
                <label for="section-padding-bottom">Padding Bottom</label>
                <div class="input-with-unit">
                  <input type="text" id="section-padding-bottom" v-model="content.styles.section.paddingBottom" placeholder="100px" />
                  <span class="unit">px</span>
                </div>
              </div>
            </div>
            ...
            <div class="color-input-group">
              <label>Màu border section</label>
              <div class="color-input form-group">
                <input type="color" v-model="content.styles.section.borderColor" />
                <input type="text" v-model="content.styles.section.borderColor" placeholder="#C2CBF0" />
              </div>
            </div>
          </div>
          ...
          <!-- Border Dash -->
          <div class="setting-section">
            <h3><i class="fas fa-border-style"></i> Đường viền đứt</h3>

            <div class="form-row">
              <div class="form-group">
                <label for="dash-width">Độ dày</label>
                <div class="input-with-unit">
                  <input type="text" id="dash-width" v-model="content.styles.section.dashWidth" placeholder="5px" />
                  <span class="unit">px</span>
                </div>
              </div>
              <div class="form-group">
                <label for="dash-position-left">Vị trí Left</label>
                <div class="input-with-unit">
                  <input type="text" id="dash-position-left" v-model="content.styles.section.dashPositionLeft" placeholder="75px" />
                  <span class="unit">px</span>
                </div>
              </div>
            </div>
            ...
            <div class="form-row">
              <div class="form-group">
                <label for="dash-width-percent">Chiều rộng</label>
                <div class="input-with-unit">
                  <input type="text" id="dash-width-percent" v-model="content.styles.section.dashWidthPercent" placeholder="80%" />
                  <span class="unit">%</span>
                </div>
              </div>
              <div class="form-group">
                <label for="dash-height-percent">Chiều cao</label>
                <div class="input-with-unit">
                  <input type="text" id="dash-height-percent" v-model="content.styles.section.dashHeightPercent" placeholder="132%" />
                  <span class="unit">%</span>
                </div>
              </div>
            </div>
          ...
          <!-- Text Content Styles -->
          <div class="setting-section">
            <h3><i class="fas fa-font"></i> Nội dung văn bản</h3>

            <div class="color-input-group">
              <label>Màu nền</label>
              <div class="color-input form-group">
                <input type="color" v-model="content.styles.textContent.backgroundColor" />
                <input type="text" v-model="content.styles.textContent.backgroundColor" placeholder="white" />
              </div>
            </div>
            ...
            <div class="color-input-group">
              ...
              <div class="color-input form-group">
                <input type="color" v-model="content.styles.textContent.borderColor" />
                <input type="text" v-model="content.styles.textContent.borderColor" placeholder="#031358" />
              </div>
            </div>

            <div class="form-row">
              <div class="form-group">
                <label for="text-border-width">Độ dày viền</label>
                <div class="input-with-unit">
                  <input type="text" id="text-border-width" v-model="content.styles.textContent.borderWidth" placeholder="2px" />
                  <span class="unit">px</span>
                </div>
              </div>
              <div class="form-group">
                ...
                <div class="input-with-unit">
                  <input type="text" id="text-border-radius" v-model="content.styles.textContent.borderRadius" placeholder="20px" />
                  <span class="unit">px</span>
                </div>
              </div>
            </div>
            ...
            <div class="form-row">
              <div class="form-group">
                ...
                <div class="input-with-unit">
                  <input type="text" id="text-margin-left" v-model="content.styles.textContent.marginLeft" placeholder="12%" />
                  <span class="unit">%</span>
                </div>
              </div>
              <div class="form-group">
                <label for="text-margin-right">Margin Right</label>
                <div class="input-with-unit">
                  <input type="text" id="text-margin-right" v-model="content.styles.textContent.marginRight" placeholder="12%" />
                  <span class="unit">%</span>
                </div>
              </div>
            </div>
            ...
            <div class="form-row">
              <div class="form-group">
                <label for="text-padding-left">Padding Left</label>
                <div class="input-with-unit">
                  <input type="text" id="text-padding-left" v-model="content.styles.textContent.paddingLeft" placeholder="50px" />
                  <span class="unit">px</span>
                </div>
              </div>
              <div class="form-group">
                ...
                <div class="input-with-unit">
                  <input type="text" id="text-padding-right" v-model="content.styles.textContent.paddingRight" placeholder="42%" />
                  <span class="unit">%</span>
                </div>
              </div>
            </div>
            ...
            <div class="form-row">
              <div class="form-group">
                <label for="text-min-height">Chiều cao tối thiểu</label>
                <div class="input-with-unit">
                  <input type="text" id="text-min-height" v-model="content.styles.textContent.minHeight" placeholder="200px" />
                  <span class="unit">px</span>
                </div>
              </div>
              <div class="form-group">
                ...
                <div class="input-with-unit">
                  <input type="text" id="text-font-size" v-model="content.styles.textContent.fontSize" placeholder="17px" />
                  <span class="unit">px</span>
                </div>
              </div>
            </div>
...
const loadData = async () => {
  try {
    ...
    if (response.data && response.data.contentJson) {
      ...
      // Assuming data structure has section7
      const sectionData = data.section7 || data
...
const saveChanges = async () => {
  try {
    ...
    // Prepare content data - wrapped in section7 for compatibility
    const contentData = {
      section7: { ...content }
    }
    ...
    const sectionData = {
      id: SECTION_ID,
      name: content.title || 'Triển khai bán nhanh bất động sản',
