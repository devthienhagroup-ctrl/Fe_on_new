      ...
      <div class="left-section">
        ...
        <div class="info-list">
          ...
          <div class="premium-button-row">
            <button
                class="btn-premium"
                @click="openFastSale(assetId, reportId, formatAddress(address), 'BN30N')"
            >
            ...
            <button
                class="btn-premium-blue"
                @click="openFastSale(assetId, reportId, formatAddress(address), null)"
            >
...
// =======================================================
const reportId = localStorage.getItem("valuationReportId");
...
// =======================================================
// 🔥 GỌI API LẤY PAYMENT INFO DTO
// =======================================================
async function loadPaymentInfo() {
  try {
    const res = await api.get(
        `/thg.user/my-land/checkout/report/${reportId}`
    );
  ...
  socketService.subscribe(
      ...
      (event) => {
        ...
        if (event.type === "PAYMENT_SUCCESS") {
          ...
          localStorage.setItem("valuationReportId", reportId);
