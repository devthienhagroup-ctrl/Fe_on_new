    ...
    <div class="nav-right">
      <div class="nav-icons">
        ...
        <div class="user-menu-container">
          <a @click="openAuthModalFromUserIcon" class="icon-link user-icon" id="user-icon">
            <i class="fa-solid fa-user"></i>
          </a>
          <div v-if="auth.userInfo != null"  class="user-submenu" id="user-submenu">
            <router-link to="/ho-so/trung-tam-tai-khoan" class="user-submenu-link">
              <i class="fas fa-user-circle"></i> Tài khoản
            </router-link>
<!--            <div v-if="auth.userInfo == null" @click="showAuthModal=true" class="user-submenu-link">-->
<!--              <i class="fas fa-sign-in-alt"></i> Đăng nhập-->
<!--            </div>-->
            <a href="#" class="user-submenu-link" @click.prevent="handleLogout">
...
const openAuthModalFromUserIcon = () => {
  if(auth.userInfo == null) {showAuthModal.value=true}
}
...
/* Các submenu cũng giữ dưới 500 */
.submenu {
  z-index: 501; /* <-- CAO HƠN MENU NHƯNG THẤP HƠN AUTHMODAL */
}

.user-submenu {
  z-index: 502; /* <-- CAO HƠN SUBMENU */
}

/* Mobile menu */
.nav-links {
  z-index: 503; /* <-- CHO MOBILE */
}
