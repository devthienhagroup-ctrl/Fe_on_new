    ...
    <div class="d-flex align-items-center justify-content-between">
      <div>
        <nav aria-label="breadcrumb">
          <ol class="breadcrumb mb-2">
            <li class="breadcrumb-item">
              <i class="fas fa-home me-1"></i><a href="/-thg/quan-ly-san-pham" class="text-decoration-none"> Quản lý sản phẩm</a>
            </li>
        ...
        <div class="d-flex align-items-center gap-3">
          ...
          <div>
            <h1 class="h3 mb-1 fw-bold text-dark">Tạo mới sản phẩm</h1>
            ...
            <div class="row g-4">
              ...
              <div class="col-md-2">
                <label class="form-label fw-semibold d-flex align-items-center gap-2">
                  ...
                  <span>Hiển thị <span class="text-danger">*</span></span>
                </label>
        ...
        <span class="input-group-text">
          ...
          <div v-show="activeTab === 'house' && isHouse" class="tab-panel">
            ...
            <div class="d-flex align-items-center mb-4 border-bottom pb-3">
              ...
              <div>
                <h2 class="h5 fw-bold mb-1">Thông tin nhà <span class="text-danger">*</span></h2>
...
const validateForm = () => {
  ...
  const normalImages = uploadedFiles.value.filter((file) => file && !file.isIG && isImageFile(file.fileName))
  const landBookImages = uploadedFiles.value.filter((file) => file && file.isIG && isImageFile(file.fileName))
